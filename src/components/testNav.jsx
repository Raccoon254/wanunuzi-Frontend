                                        ...
                                        {navigation.map((item) => (
                                            <a
                                                ...
                                                className={classNames(
                                                    item.current ? 'font-bold text-white' : 'text-gray-300 hover:bg-customGreen hover:text-white',
                                                    'rounded-md px-3 py-2 text-sm font-medium'
                                                )}
                                                aria-current={item.current ? 'page' : undefined}
                                            >
                                                <button className="p-2 mr-2 inline-flex items-center justify-center rounded-full border text-white ring-1 ring-green-900">
                        ...
                        <div className="space-y-1 px-2 pb-3 pt-2">
                            {navigation.map((item) => (
                                <Disclosure.Button
                                    ...
                                    href={item.href}
                                    className={classNames(
                                        item.current ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-customGreen hover:text-white',
                                        'block rounded-md px-3 py-2 text-base font-medium'
                                    )}
                                    aria-current={item.current ? 'page' : undefined}
                                >
                                        <button className="p-2 mr-2 inline-flex items-center justify-center rounded-full border text-white ring-2 ring-customGreen">
                                             <i className={item.icon}></i>
                                        </button>
                                    {item.name}
